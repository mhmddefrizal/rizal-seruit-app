<div class="relative my-3 w-full xl:mt-2 mt-8">
    <input id="search_1" type="text" placeholder="Cari aplikasi.." class="search_app w-full px-4 py-2 border border-neutral-200 rounded-lg
