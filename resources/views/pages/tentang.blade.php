    ...
    <div class="mt-10">
      ...
      <div class="bg-gray-50 rounded-lg p-6 border border-gray-200">
        <p class="text-gray-700 leading-relaxed text-justify">
          Aplikasi <strong>SERUIT</strong> merupakan hasil kolaborasi dari berbagai pihak yang berkontribusi dalam
        ...
        <ul class="list-disc pl-5 mt-4 space-y-2 text-gray-700">
          <li><strong>Tim IT BPS Provinsi Lampung</strong> — Sebagai pengarah dan pengembang utama sistem.</li>
          <li><strong>Mahasiswa Universitas Lampung (UNILA)</strong> — Berperan dalam pengembangan fitur dan
            implementasi.</li>
          <li><strong>Mahasiswa Universitas Teknokrat Indonesia (UTI)</strong> — Berkontribusi dalam pengembangan UI/UX
            dan fitur aplikasi, meliputi navigasi kategori berbasis card, peningkatan responsivitas, akses aplikasi via
            pop-up, serta filter akses (VPN & publik).</li>
        </ul>
