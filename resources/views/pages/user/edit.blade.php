      ...
      <div class="mt-3 sm:mt-5">
        <form action="{{ route('users.update', $user->slug) }}" method="POST">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label class="block text-sm sm:text-base text-gray-700 font-medium mb-1">Password <span class="text-gray-500 text-xs sm:text-sm">(kosongkan jika tidak diganti)</span></label>
