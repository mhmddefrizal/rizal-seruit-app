    ...
    <div class="bg-white overflow-hidden shadow-sm rounded-lg">
        <div class="p-4 sm:p-6 bg-white border-b border-gray-200">
            ...
            <div class="mobile-only mobile-card-stack">
                ...
                <div id="mobile-empty-listapp" class="mobile-empty-state hidden">Aplikasi tidak ditemukan.</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            initMobileCardSearchPagination({
                ...
                pagerSelector: '#mobile-pagination-listapp',
                searchFormSelector: '.mobile-search-form',
                searchInputSelector: '.mobile-search-input',
                emptyStateSelector: '#mobile-empty-listapp',
                itemsPerPage: 5
            });
