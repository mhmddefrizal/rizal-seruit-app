            ...
            <div class="mt-3 sm:mt-5 flex flex-col md:flex-row items-center md:items-start gap-4 sm:gap-6">
                ...
                <div class="flex-1 w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-gray-800">
                                        <a href="{{ $app->link }}" class="text-indigo-600 hover:underline break-all"
                                            target="_blank">
                                            {{ $app->link }}
                                        </a>
                                    </td>
                    ...
                    <div class="mobile-only space-y-3">
                        ...
                        <div class="border-b border-gray-100 pb-2">
                            <span class="block text-xs font-semibold text-gray-500 uppercase tracking-wide">Deskripsi
                                Singkat</span>
                        ...
                        <div>
                            ...
                            <a href="{{ $app->link }}"
                                class="block text-sm text-indigo-600 hover:underline mt-0.5 break-all" target="_blank">
                                {{ $app->link }}
                            </a>
                        </div>
                    </div>
