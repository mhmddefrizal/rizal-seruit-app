...
const { toString: Ze } = Object.prototype,
    ...
    { iterator: v, toStringTag: Ne } = Symbol,
    G = ((e) => (t) => {
        const n = Ze.call(t);
...
const et = Q("string"),
    ...
    [ut, ft, dt, pt] = ["ReadableStream", "Request", "Response", "Headers"].map(
        C
    ),
    ht = (e) =>
...
const Ut = (e) => {
    ...
    Lt = C("AsyncFunction"),
    Bt = (e) => e && (I(e) || A(e)) && A(e.then) && A(e.catch),
    Be = ((e, t) =>
        e
            ? setImmediate
            : t
            ...
            d.push(p),
                a.forEach(p, function (w, S) {
                    (!(a.isUndefined(w) || w === null) &&
                        s.call(t, w, a.isString(S) ? S.trim() : S, y, b)) ===
...
const Ie = {
    ...
    Mt = typeof URLSearchParams < "u" ? URLSearchParams : fe,
    zt = typeof FormData < "u" ? FormData : null,
    $t = typeof Blob < "u" ? Blob : null,
    Jt = {
        isBrowser: !0,
        classes: { URLSearchParams: Mt, FormData: zt, Blob: $t },
    ...
    Kt = (de && window.location.href) || "http://localhost",
    Xt = Object.freeze(
...
const Ve = (e) => {
        ...
        if (
            ...
            (r && a.isFunction(r) && (r = r(t)), r || (r !== !1 && ln(t.url)))
        ) {
    ...
    We = Y && typeof ReadableStream == "function",
    En =
        Y &&
    ...
    Oe = 64 * 1024,
    ae = We && Ke(() => a.isReadableStream(new Response("").body)),
    X = { stream: ae && ((e) => e.body) };
Y &&
    ((e) => {
    ...
    On =
        ...
        (async (e) => {
            ...
            try {
                ...
                l = l || "text";
                let P = await X[a.findKey(X, l) || "text"](S, e);
                return (
                    !g && y && y(),
...
const W = { assertOptions: An, validators: ee },
    N = W.validators;
let L = class {
    constructor(t) {
        (this.defaults = t || {}),
